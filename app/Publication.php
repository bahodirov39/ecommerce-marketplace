...
class Publication extends Model
{
    ...
    const TYPE_PROMOTION = 12;
    const TYPE_VIDEO = 13;
    const TYPE_ARTICLE = 14;
    ...
    {
        return $query->where('type', static::TYPE_ARTICLE);
    }
    ...
    public function typePage()
    {
        ...
        $pageId = 0;
        switch ($this->type) {
            case self::TYPE_ARTICLE: $pageId = 18; break;
            case self::TYPE_NEWS: $pageId = 17; break;
            case self::TYPE_PROMOTION: $pageId = 4; break;
            case self::TYPE_VIDEO: $pageId = 12; break;
