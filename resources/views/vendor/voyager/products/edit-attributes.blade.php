                                ...
                                <div id="selected_attributes">
                                    @foreach($product->attributes as $attribute)
                                        <div class="removable-block mb-15">
                                            ...
                                            <div class="form-group">
                                                <h5>Order {{ $attribute->name }}<span class="remove-block pull-right cursor-pointer">&times;</span></h5>
                                                <input type="text" class="form-control" placeholder="Order" name="attributes[{{ $attribute->id }}][order]" value="{{ $attribute->pivot->order }}">
                                            </div>
            ...
            $('#add_attribute').on('click', function(e){
                ...
                container.append(`
                    <div class="removable-block mb-15">
                        ...
                        <div class="form-group">
                            <h5>Order<span class="remove-block pull-right cursor-pointer">&times;</span></h5>
                            <input type="text" class="form-control" placeholder="Order" name="attributes[${attribute}][order]">
                        </div>
