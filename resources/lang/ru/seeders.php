...
return [
    ...
    'data_types' => [
        ...
        'import_partner' => [
            'singular' => 'Партнер (импорт)',
            'plural' => 'Партнеры (импорт)',
        ],
        'import_partner_margin' => [
            'singular' => 'Наценка (импорт)',
            'plural' => 'Наценки (импорт)',
        ],
        'installment_plan' => [
            'singular' => 'Месяцы рассрочки',
            'plural' => 'Месяцы рассрочки',
        ],
        'menu' => [
            'singular' => 'Меню',
            'plural' => 'Меню',
    ...
    'menu_items' => [
        ...
        'genders' => 'Пол',
        'import' => 'Импорт',
        'import_partners' => 'Партнеры (импорт)',
        'import_partner_margins' => 'Наценки (импорт)',
        'installment_plans' => 'Месяцы рассрочки',
        'media' => 'Медиа',
