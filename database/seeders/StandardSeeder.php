...
class StandardSeeder extends Seeder
{
    ...
    protected function dropdown($defaultSelected = '1', array $options = ['1' => 'Item 1'], $otherDetails = [])
    {
        $details = [
    ...
    protected function orderRow($data = [])
    {
        return array_merge([
            'type'         => 'number',
    ...
    protected function descriptionRow($data = [])
    {
        return array_merge([
            'type'         => 'text_area',
            'display_name' => __('seeders.data_rows.short_description'),
            'required'     => 0,
            'browse'       => 0,
            'read'         => 1,
            'edit'         => 1,
    ...
    protected function requiredNumberRow($data = [])
    {
        return array_merge([
            'type'         => 'text',
            'display_name' => 'Required Number',
            'required'     => 1,
            'browse'       => 1,
            'read'         => 1,
            'edit'         => 1,
    ...
    protected function percentRow($data = [])
    {
        return array_merge([
            'type'         => 'text',
            ...
            'delete'       => 1,
            'order'        => 12,
            'details'      => $this->requiredNumber(0, 100),
        ], $data);
    }
